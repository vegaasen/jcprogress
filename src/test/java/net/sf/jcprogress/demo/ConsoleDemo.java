...
import net.sf.jcprogress.abs.ProgressThread;
import net.sf.jcprogress.indicator.BubbleCharIndicator;
import net.sf.jcprogress.indicator.CounterClockwiseRotCharIndicator;
...
public class ConsoleDemo implements ProgressStatusProvider {
    ...
    public static void main(String[] args) {
        ...
        ConsoleProgressThreadBase progress;
