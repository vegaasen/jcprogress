...
//	private final Log logger = LogFactory.getLog(ProgressCalculator.class);
    ...
    /**
     * @param progressWhole       number of items to process at all
     * @param stalledTimeWindowMs milliseconds after which stalled activity is assumed
     */
    ...
    /**
     * @param startTime           start time in system time milliseconds
     * @param progressWhole       number of items to process at all
     * @param stalledTimeWindowMs milliseconds after which stalled activity is assumed
     */
     ...
     *
     * @return estimated whole time in milliseconds
     */
     ...
     * estimate the whole time
     *
     * @param currentMillis current time in system time milliseconds
     * @return estimated whole time in milliseconds
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final ProgressCalculator other = (ProgressCalculator) obj;
        return this.progressCount == other.progressCount &&
                this.progressWhole == other.progressWhole &&
